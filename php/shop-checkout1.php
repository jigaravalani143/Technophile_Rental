    ...
    <div id="all">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg" style="position:fixed;width:100%;">
          <div class="container"><a href="homepag1.php" class="navbar-brand home"><img src="../html1/img/technophilerentalimages/logo.jpg" alt="Universal logo" class="d-none d-md-inline-block" width="110" height="75"><img src="../html1/img/technophilerentalimages/logo.jpg" alt="Universal logo" class="d-inline-block d-md-none" width="110" height="75"><span class="sr-only">Universal - go to homepage</span></a>
