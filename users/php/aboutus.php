						...
						<div id="carouselExampleControls" class="carousel slide" data-ride="carousel"  style="width:400px;">
			  				<div class="carousel-inner">
			    				<div class="carousel-item active">
			      					<img class="d-block w-100 img-circle" src="../html1/img/technophilerentalimages/k.jpg" alt="First slide">
			    				...
			    				<div class="carousel-item">
			      					<img class="d-block w-100 img-circle" src="../html1/img/technophilerentalimages/p1.jpg" alt="Second slide">
			      						<div class="carousel-caption d-none d-md-block">
			      						<h3>Priyam Vora</h3>
			      						<p>Currently pursuing diploma in Information Technology at Shri Bhagubai Mafatlal Polytechnic</p>
			      					</div>
			    				...
			    				<div class="carousel-item">
			      					<img class="d-block w-100 img-circle" src="../html1/img/technophilerentalimages/mi.jpg" alt="Third slide">
